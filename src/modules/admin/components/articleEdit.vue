      ...
      art_id
            ...
            getArticle() {
                axios({
                    ...
                    .then(function (response) {
                        let info = response.data.data.article[0];
                        this.content = info.art_content;
                        this.art_title = info.art_title;
                        this.art_des = info.art_des;
                        this.html = this.content && converter.makeHtml(this.content);
                        this.category_id = info.art_category_id;
                        console.log(info)
                    }.bind(this));
            },
            getCategories() {
